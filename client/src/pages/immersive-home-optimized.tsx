...
const ImmersiveHome: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Space intro with seamless transition to mountains */}
      <div className="relative">
        <SpaceIntroSection />
        {/* Special connector between space and mountain */}
        <div className="absolute bottom-0 left-0 right-0 h-[50vh] w-full bg-gradient-to-b from-transparent to-[#070f24] z-10 pointer-events-none"></div>
      </div>
      
      {/* Mountain section that overlaps with space section */}
      <div className="relative min-h-screen -mt-[50vh]" id="mountain-section">
        {/* Text that will appear over mountain but scroll behind it */}
        <div className="absolute top-0 left-0 right-0 w-full z-20 pt-32 pb-40 text-center">
          <motion.div
        ...
        {/* The mountain image with higher z-index */}
      ...
      {/* Description section with seamless transition */}
      ...
      {/* Mountain with stat - seamless transition */}
      ...
      {/* Interactive Agent selection - seamless transition */}
      <div className="relative -mt-12">
      ...
      {/* Mountain transition to pricing - seamless transition */}
      <div className="relative -mt-12">
      ...
      {/* Pricing section - seamless transition */}
      <div className="relative -mt-24">
      ...
      {/* Footer/Contact - seamless transition */}
      <div className="relative -mt-12">
